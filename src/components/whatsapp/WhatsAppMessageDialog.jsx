...
export default function WhatsAppMessageDialog({ open, onOpenChange, cls, contacts = [], students = [], initialContactId, canManage = false, onManage }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent dir="rtl" className="w-[calc(100vw-1rem)] max-w-xl max-h-[92svh] overflow-hidden p-0 gap-0 rounded-3xl">
        ...
        <div className="max-h-[72svh] overflow-y-auto p-4 space-y-4">
          {contacts.length > 1 && (
        ...
        <div className="grid grid-cols-[1fr_2.5fr] gap-2 p-4 border-t border-border/60 bg-background/80">
          <Button type="button" variant="outline" onClick={() => onOpenChange(false)}>ביטול</Button>
          <Button type="button" onClick={handleOpenWhatsApp} className="bg-emerald-600 hover:bg-emerald-700 text-white">
