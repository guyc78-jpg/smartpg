...
function MobileNavItem({ to, icon: Icon, label }) {
  ...
  return (
    ...
    >
      ...
      <Icon className={`relative w-5 h-5 transition-transform duration-300 ${active ? 'scale-110' : ''}`} />
...
export default function BottomNav() {
  return (
    ...
    >
      <div className="pointer-events-auto flex items-stretch h-[60px] px-2 rounded-full glass-nav border border-border/40 shadow-lg">
