...
export default function TestsPage() {
  ...
  const currentTest = classTests[selectedTestIdx] ?? classTests[0] ?? null;
            ...
            <div className="relative">
              <button onClick={() => setListOpen(o => !o)} className="w-full flex items-center justify-between btn-3d bg-card rounded-xl px-4 py-2 active:scale-[0.98] transition-all">
                <div className="text-right">
                  ...
                  <div className="text-[11px] text-muted-foreground">{currentTest?.unit || 'תוצאה'} • {selectedTestIdx + 1} / {classTests.length}</div>
                </div>
